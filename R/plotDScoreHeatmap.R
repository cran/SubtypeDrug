...
##' @param SDS A string indicates that the range of SDS is used for the heat map. if SDS="all" (default), the SDS will not be screened.
##' SDS="negative", only drugs with SDS<0 are used. SDS="positive", only drugs with SDS>0 are used.
##' @param E_Pvalue.th A numeric.A threshold is used to screen the drug effected P value.
##' @param E_FDR.th A numeric.A threshold is used to screen the drug effected FDR.
##' @param S_Pvalue.th A numeric.A threshold is used to screen the Subtype specific P value.
##' @param S_FDR.th A numeric.A threshold is used to screen the Subtype specific P value.
...
##' @export
plotDScoreHeatmap<-function(data,subtype.label="all",SDS="all",E_Pvalue.th=0.05,E_FDR.th=0.05,S_Pvalue.th=0.05,S_FDR.th=0.05,show.rownames = TRUE,
                          show.colnames = TRUE,fontsize = 10, fontsize.row = 10, fontsize.col = 10,scale = "row"){
